...
url='http://tds.hycom.org/thredds/dodsC/datasets/GLBy0.08/expt_93.0/data/hindcasts/2019/hycom_glby_930_2019120412_t000_uv3z.nc'
...
while iTime <= endTime:
    ...
    url='http://tds.hycom.org/thredds/dodsC/datasets/GLBy0.08/expt_93.0/data/hindcasts/%04d/hycom_glby_930_%s12_t000_uv3z.nc' % (year, iTime.strftime("%Y%m%d"))
    writeFile = True
