...
#   src_varu = src_varu[0,:, yrange[0]:yrange[1]+1, xrange[0]:xrange[1]+1]
    ...
    print 'subgrid 3d', src_varu.shape
#   src_varv = src_varv[0,:, yrange[0]:yrange[1]+1, xrange[0]:xrange[1]+1]
    ...
    print 'subgrid 3d', src_varv.shape
    ...
    ncu.variables['u_north'].time = 'ocean_time'
    ...
    ncu.variables['u_south'].time = 'ocean_time'
    ...
    ncu.variables['u_east'].time = 'ocean_time'
    ...
    ncu.variables['u_west'].time = 'ocean_time'
    ...
    ncu.variables['ubar_north'].time = 'ocean_time'
    ...
    ncu.variables['ubar_south'].time = 'ocean_time'
    ...
    ncu.variables['ubar_east'].time = 'ocean_time'
    ...
    ncu.variables['ubar_west'].time = 'ocean_time'
    ...
    ncv.variables['v_north'].time = 'ocean_time'
    ...
    ncv.variables['v_south'].time = 'ocean_time'
    ...
    ncv.variables['v_east'].time = 'ocean_time'
    ...
    ncv.variables['v_west'].time = 'ocean_time'
    ...
    ncv.variables['vbar_north'].time = 'ocean_time'
    ...
    ncv.variables['vbar_south'].time = 'ocean_time'
    ...
    ncv.variables['vbar_east'].time = 'ocean_time'
    ...
    ncv.variables['vbar_west'].time = 'ocean_time'
