...
#    nc.variables['ocean_time'][:] = time
    ...
    nc.createVariable(outvarname, 'f', ('ocean_time', 's_rho', 'eta_u', 'xi_u'), fill_value=spval)
    ...
    nc.variables[outvarname].coordinates = 'ocean_time s_rho lon_u lat_u'
...
#lon = dataset.variables['lon_u'][170:215,195:265-1]
#lat = dataset.variables['lat_u'][170:215,195:265-1]
