...
def remap_bdry_uv(src_file, src_grd, dst_grd, cdepth=0, kk=2, dst_dir='./', irange=None, jrange=None):
    ...
    print('shapes', src_uz.shape, src_vz.shape)
    ...
    # rotate u,v fields
#   src_angle = regrid_GLORYS(src_grd.angle, method='bilinear', irange=irange, jrange=jrange)
