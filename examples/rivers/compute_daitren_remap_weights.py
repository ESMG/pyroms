...
grid2_file = 'remap_grid_NWGOA_rho.nc'
interp_file1 = 'remap_weights_daitren_to_NWGOA_conservative_nomask.nc'
interp_file2 = 'remap_weights_NWGOA_to_daitren_conservative_nomask.nc'
map1_name = 'daitren to NWGOA conservative Mapping'
map2_name = 'NWGOA to daitren conservative Mapping'
num_maps = 1
