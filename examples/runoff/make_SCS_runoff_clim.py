...
# load SCS grid object
grd = pyroms.grid.get_ROMS_grid('SCS')


# define some variables
wts_file = 'remap_weights_daitren_to_SCS_conservative_nomask.nc'
nt = data.shape[0]
...
# create runoff file
#runoff_file = 'runoff_SCS_daitren_inter_annual_2002-2004.nc'
runoff_file = 'runoff_SCS_daitren_clim.nc'
nc = netCDF.Dataset(runoff_file, 'w', format='NETCDF3_64BIT')
nc.Description = 'Dai & Trenberth monthly climatology river discharge'
nc.Author = 'make_SCS_runoff.py'
