...
def sview(var, tindex, sindex, grid, filename=None, \
          cmin=None, cmax=None, clev=None, \
    ...
    plot a constante-sigma slice of variable var. If filename is provided,
    ...
    if fill == True:
        sslice, lon, lat = pyroms.tools.sslice(var, sindex, grd, \
                                  Cpos=Cpos)
    else:
        sslice, lon, lat = pyroms.tools.sslice(var, sindex, grd, \
                                  Cpos=Cpos, vert=True)
